...
const FormModal = ({ open, handleClose, inputs, handleChange, handleSubmit, style }) => {
  ...
  const validate = () => {
    let tempErrors = {};
    tempErrors.primerNombre = inputs.primerNombre ? "" : "Este campo es requerido.";
    tempErrors.segundoNombre = inputs.segundoNombre ? "" : "Este campo es requerido.";
    tempErrors.apellidoPaterno = inputs.apellidoPaterno ? "" : "Este campo es requerido.";
    tempErrors.apellidoMaterno = inputs.apellidoMaterno ? "" : "Este campo es requerido.";
    tempErrors.run = inputs.run ? "" : "Este campo es requerido.";
    tempErrors.correoInstitucional = inputs.correoInstitucional ? "" : "Este campo es requerido.";
    tempErrors.telefono = inputs.telefono ? "" : "Este campo es requerido.";
    tempErrors.telefono = inputs.telefono && inputs.telefono.length === 9 ? "" : "El teléfono debe tener 9 dígitos.";
  ...
  return (
    <Modal open={open} onClose={handleClose}>
      <Box sx={{ ...style, overflow: "auto", maxHeight: "90vh" }}>
        ...
        <Box component="form" noValidate onSubmit={handleSubmitWithValidation} sx={{ mt: 1 }}>
          <TextField
            margin="normal"
            required
            fullWidth
